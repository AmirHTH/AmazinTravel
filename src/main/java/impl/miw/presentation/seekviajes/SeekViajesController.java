package impl.miw.presentation.seekviajes;
...
public class SeekViajesController {
	...
	@RequestMapping(value="private/seekViajes", method = RequestMethod.POST)
	public String seekViajes(@Valid @ModelAttribute ParamBusquedaViaje param, BindingResult result, Model model  )
	{

		if ( result.hasErrors())
		{
			System.out.println("---- Has Errors -----");
			return "private/seekViajes";
